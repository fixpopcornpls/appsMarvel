...
//  heroesMarvel
//
//  Created by Илья Лучинский on 20.10.2021.
//
...
class ViewController: UIViewController {
    ...
    let pictures = ["Carnage", "Doctor Doom", "Iron man", "Spider man", "Venom"]
    let name = ["Carnage", "Doctor Doom", "Iron man", "Spider man", "Venom"]
